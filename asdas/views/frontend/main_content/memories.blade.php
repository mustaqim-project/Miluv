...
<div class="memories single-item-countable single-entry p-0">
    <div class="entry-inner p-0">
        <img src="{{ url('assets/frontend/images/memories_background.png') }}" class="w-100" alt="memories-banner-area">
        <p class="text-center mb-0 pb-3 mt-2 px-5">
            @if ($posts->count() > 0)
                {{ get_phrase('We hope you enjoy revisiting and sharing your memories on miluv from the most recent moments to those from days gone by.') }}
            @else
