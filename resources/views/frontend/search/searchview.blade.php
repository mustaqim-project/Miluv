            ...
            <div class="people-wrap sust_entery">
                <div class="people-item d-sm-flex mb-3 justify-content-between w-100">
                    ...
                    @if ($friend>0)
                        ...
                        @endif
                    @else   
                        <a href="javascript:void(0)" onclick="ajaxAction('<?php echo route('user.friend',$people->id); ?>')" class="btn common_btn align-self-start mt-2"><i class="fa-solid fa-plus"></i> {{ get_phrase('Connect') }} </a>
                    @endif
