...
<div class="eBlock mt-3">
    ...
    <form action="{{route('block_user_post', $post->post_id)}}" method="post">
        ...
        <p>{{get_phrase('If you just want to limit what you share with')}} {{$post->getUser->name}} {{get_phrase('or see less of him on Miluv, you can take a break from him instead.')}}</p>
