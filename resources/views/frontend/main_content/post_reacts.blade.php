...
<div class="post-react d-flex align-items-center">
    ...
    <ul class="react-icons">
        @foreach($unique_values as $user_react)
            @if($user_react == 'like')
                {{-- <li><img class="w-17px" src="{{url('storage/images/like.svg')}}" alt=""></li> --}}
            ...
            @if($user_react == 'love')
                <li><img class="w-22px" src="{{url('storage/images/love.svg')}}" alt=""></li>
            @endif

            @if($user_react == 'sad')
                <li><img class="w-17px" src="{{url('storage/images/sad.svg')}}" alt=""></li>
            @endif

            @if($user_react == 'angry')
                <li><img class="w-17px" src="{{url('storage/images/angry.svg')}}" alt=""></li>
            @endif

            @if($user_react == 'haha')
                <li><img class="w-17px" src="{{url('storage/images/haha.svg')}}" alt=""></li>
            @endif
        @endforeach
    </ul>
    ...
    @if(array_key_exists($user_info->id, $user_reacts))
        ...
        @if($user_reacts[$user_info->id] == 'love')
            <div class="love-color">
                <img class="w-22px mt--4px" src="{{url('storage/images/love.svg')}}" alt="">
                {{get_phrase('Loved')}}
            </div>
        @endif
        ...
        @if($user_reacts[$user_info->id] == 'haha')
            <div class="sad-color">
                <img class="w-17px mt--4px" src="{{url('storage/images/haha.svg')}}" alt="">
                {{get_phrase('Haha')}}
            </div>
        @endif
        ...
        @if($user_reacts[$user_info->id] == 'angry')
            <div class="angry-color">
                <img class="w-17px mt--4px" src="{{url('storage/images/angry.svg')}}" alt="">
                {{get_phrase('Angry')}}
            </div>
        @endif
        ...
        @if($user_reacts[$user_info->id] == 'sad')
            <div class="sad-color">
                <img class="w-17px mt--4px" src="{{url('storage/images/sad.svg')}}" alt="">
                Sad
            </div>
        @endif
    @else
        ...
        @else
            <div>
                <img class="w-17px mt--6px" src="{{url('storage/images/like2.svg')}}" alt="">
