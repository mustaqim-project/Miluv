        ...
        <div class="modal-header d-flex bg-secondary">
            ...
            <div class="avatar d-flex">
                <a href="#" class="d-flex align-items-center">
                    <div class="avatar avatar-lg me-2">
                        <img src="{{ get_user_image($reciver_data->photo, 'optimized') }}" class="rounded-circle h-45"
                            alt="">
                    ...
                    <div class="name">
                        ...
                        @else
                            <small class="d-block">
                                {{ \Carbon\Carbon::parse($reciver_data->lastActive)->diffForHumans() }}</small>
                        @endif
                    </div>
                </a>
            </div>
            <div class="chat-actions">
                ...
                <ul class="dropdown-menu" aria-labelledby="dropdownMenuButton1">
                    <li><a class="dropdown-item" href="{{ route('user.profile.view', $reciver_data->id) }}"><i
                                class="fa fa-user"></i>
