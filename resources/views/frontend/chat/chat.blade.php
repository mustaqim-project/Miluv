        ...
        <div class="modal-header d-flex bg-secondary">
            ...
            <div class="chat-actions">
                ...
                <ul class="dropdown-menu" aria-labelledby="dropdownMenuButton1">
                    <li>
                        <a class="dropdown-item" href="{{ route('user.profile.view', $reciver_data->id) }}">
                            <i class="fa fa-user"></i> {{ get_phrase('View Profile') }}
                        </a>
                    </li>
                </ul>
            </div>
        ...
        @if (!empty($reciver_data))
            ...
            <form class="ajaxForm" id="chatMessageFieldForm" action="{{ route('chat.save') }}" method="POST"
                ...
                <div class="nm_footer d-flex">
                    ...
                    <input type="text" class="form-control flex-grow-1 me-2" name="message" id="ChatmessageField" placeholder="Type a message">
                    
                    <a href="javascript:void(0)" id="messgeImageUploader" class="d-flex align-items-center me-2">
                        <img src="{{ asset('assets/frontend/images/image-a.png') }}" alt="" style="width: 24px; height: 24px;">
                    </a>
                    
                    <button class="btn btn-primary send no-processing no-uploading" id="ChatsentButton">
