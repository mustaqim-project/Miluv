        ...
        <div class="m-user-action">
            <div class="post-controls dropdown dotted">
                ...
                <ul class="dropdown-menu" aria-labelledby="navbarDropdown">
                    ...
                    <li><a class="dropdown-item text-danger" href="{{ route('chat.end', $user->id) }}" onclick="return confirm('Apakah Anda yakin ingin mengakhiri chat ini?');"><i class="fa fa-times"></i> End Chat</a></li>
                </ul>
            </div>
        </div>
    </div>
