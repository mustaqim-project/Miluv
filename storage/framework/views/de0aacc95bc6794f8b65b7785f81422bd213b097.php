<?php $__currentLoopData = $previousChatList; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $previousChatList): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
    ...
    ?>
    <div class="single-contact message_ava d-flex align-items-center justify-content-between <?php if($unreadMsgCount>1): ?> bg-my-black <?php endif; ?>">
...
<?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?><?php /**PATH D:\AGUNG MUSTAQIM\drive-download-20250218T071143Z-001\PROJECT-BY-LARAGON\PROJECT-BY-LARAGON\Sociopro\resources\views/frontend/chat/single-chated.blade.php ENDPATH**/ ?>