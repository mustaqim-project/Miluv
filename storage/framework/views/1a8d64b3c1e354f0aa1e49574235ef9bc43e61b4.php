                             ...
                             <p class="mb-0"><?php echo e(get_phrase('Add to your post')); ?></p>
                                <div>
                                    <button type="button" data-tab="tab-file" class="btn btn-secondary m_btn"><img
                                        src="<?php echo e(url('storage/images/image.svg')); ?>"
                                        alt="photo"></button>
...
<?php /**PATH D:\AGUNG MUSTAQIM\drive-download-20250218T071143Z-001\PROJECT-BY-LARAGON\PROJECT-BY-LARAGON\Sociopro\resources\views/frontend/main_content/create_post_modal.blade.php ENDPATH**/ ?>