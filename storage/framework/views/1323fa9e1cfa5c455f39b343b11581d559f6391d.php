        ...
        <div class="mt-action"> 
            ...
            <form class="ajaxForm" id="chatMessageFieldForm" action="<?php echo e(route('chat.save')); ?>" method="POST" enctype="multipart/form-data">
                ...
                <div class="mt-footer">
                    ...
                    <a href="javascript:void(0)" id="messgeImageUploader"><img src="<?php echo e(url('assets/frontend/images/image-a.png')); ?>" alt=""></a>
...
<?php $__env->stopSection(); ?><?php /**PATH D:\AGUNG MUSTAQIM\drive-download-20250218T071143Z-001\PROJECT-BY-LARAGON\PROJECT-BY-LARAGON\Sociopro\resources\views/frontend/chat/chat.blade.php ENDPATH**/ ?>