<form class="ajaxForm" action="<?php echo e(route('profile.my_info', ['action_type' => 'update'])); ?>" method="post">
  ...
  <div class="mb-3">
    ...
    <button type="submit" class="btn common_btn w-100"><?php echo e(get_phrase('Save')); ?></button>
    
  </div>
</form>

<?php echo $__env->make('frontend.initialize', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\AGUNG MUSTAQIM\drive-download-20250218T071143Z-001\PROJECT-BY-LARAGON\PROJECT-BY-LARAGON\Sociopro\resources\views/frontend/profile/my_info_edit.blade.php ENDPATH**/ ?>