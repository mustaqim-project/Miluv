                            ...
                            <div class="post-controls dropdown">
                                ...
                                <ul class="dropdown-menu" aria-labelledby="navbarDropdown">
                                    <li><a class="dropdown-item" href="#"><img
                                                src="<?php echo e(url('assets/frontend/images/save.png')); ?>" alt="">
                                            <?php echo e(get_phrase('Save Video')); ?></a></li>
                                    <li><a class="dropdown-item" href="#"><img
                                                src="<?php echo e(url('assets/frontend/images/link.png')); ?>"
                                                alt=""><?php echo e(get_phrase('Copy Link')); ?></a></li>
                                    <li><a class="dropdown-item" href="#"><img
                                                src="<?php echo e(url('assets/frontend/images/report.png')); ?>"
                    ...
                    <ul class="dropdown-menu post_dots" aria-labelledby="navbarDropdown">
                        <input type="hidden" id="copy_post_<?php echo e($post->post_id); ?>"
                            ...
                            <li><a class="dropdown-item" href="javascript:void(0)" value="copy"
                                    onclick="copyToClipboard('copy_post_<?php echo e($post->post_id); ?>')"><img
                                        src="<?php echo e(url('storage/images/link.png')); ?>"
                                        alt=""><?php echo e(get_phrase('Copy Link')); ?></a></li>
                        <?php if($post->user_id == auth()->user()->id): ?>
                        ...
                        <li><a class="dropdown-item" href="javascript:void(0)"
                                ...
                                data-bs-toggle="modal" data-bs-target="#createEvent"><img
                                    src="<?php echo e(url('storage/images/report.png')); ?>"
                    ...
                    <div class="py-1">
                        <div class="text-quote image">
                              ...
                              <a class="ellipsis-line-1 ellipsis-line-2" href="<?php echo e(route('fundraiser.profile', $fundShare->id)); ?>">
                                   <img src="<?php echo e(url('assets/frontend/images/campaign/' . $fundShare->cover_photo)); ?>"
                                     ...
                                     <?php else: ?>
                                      <img src="<?php echo e(url('storage/blog/coverphoto/default/default.jpg')); ?>" class="card-img-top" alt="blog">
                            <?php endif; ?>
                        </div>
                    </div>
                    ...
                    <div class="footer-share d-flex justify-content-around">
                        ...
                        <span class="entry-react">
                            <a href="javascript:void(0)"
                                ...
                                <img width="19px" src="<?php echo e(url('storage/images/comment2.svg')); ?>">
                        ...
                        <?php if(!isset($has_memories)): ?>
                            <span class="entry-react" data-bs-toggle="modal" data-bs-target="">
                                <a href="javascript:void(0)"
                                    ...
                                    <img width="19px" src="<?php echo e(url('storage/images/share2.svg')); ?>">
...
<?php /**PATH D:\AGUNG MUSTAQIM\drive-download-20250218T071143Z-001\PROJECT-BY-LARAGON\PROJECT-BY-LARAGON\Sociopro\resources\views/frontend/main_content/posts.blade.php ENDPATH**/ ?>