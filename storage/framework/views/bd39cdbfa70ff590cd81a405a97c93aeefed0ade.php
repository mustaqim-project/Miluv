    ...
    <?php if($message->reciver_id==auth()->user()->id): ?>
                ...
                <div class="quote-box">
                    <div class="text-quote mt-0">
                        <?php if(\Illuminate\Support\Str::contains($message->message, 'http','https')): ?>
                            ...
                            <?php endif; ?>
                            <a class="text-dark ellipsis-line-2" href="<?php echo e($message->message); ?>" target="_blank"><?php echo $message->message; ?></a>
                        <?php else: ?>
        ...
        <?php if(!empty($message->thumbsup)&&empty($message->message)): ?>
            <div class="d-flex user-quote position-relative">
                <img src="<?php echo e(get_user_image($user->id,'optimized')); ?>" alt="" class="avatar-sm me-2">
                <div class="chat-react"><img src="<?php echo e(url('assets/frontend/images/like-lg.png')); ?>" alt=""></div>
            </div>
        <?php endif; ?>
            ...
            <div class="d-flex user-quote user-reply justify-content-start">
                <?php $__currentLoopData = $files; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $file): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <?php if($file->file_type=="image"): ?>
                        <div class="quote-box">
                            <img src="<?php echo e(url('storage/chat/images/'.$file->file_name)); ?>" alt="" class="quote_image_box_image" >
                        </div>
                    <?php else: ?>
                        <div class="quote-box">
                            <video class="w-100 shorts_custom_height" controls>
                                <source src="<?php echo e(url('storage/chat/videos/'.$file->file_name)); ?>" type="">
                            </video>
                        </div>
                    <?php endif; ?>
                ...
                <div class="text-quote mt-0">
                    <?php if(\Illuminate\Support\Str::contains($message->message, 'http','https')): ?>
                        ...
                        <?php else: ?>
                            <iframe src="<?php echo e(route('single.product.iframe',$shared_id)); ?>?shared=yes" scrolling="no"  class="w-100" onload="resizeIframe(this)" frameborder="0"></iframe>
                        <?php endif; ?>
                        <a href="<?php echo e($message->message); ?>" class="text-dark ellipsis-line-2" target="_blank"><?php echo $message->message; ?></a>
                    <?php else: ?>
                    <?php echo $message->message; ?>
                    ...
                    <?php $__currentLoopData = $files; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $file): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <?php if($file->file_type=="image"): ?>
                            <div class="quote-box d-flex">
                                ...
                                <img class="rounded" src="<?php echo e(url('storage/chat/images/'.$file->file_name)); ?>" class="quote_image_box_image"  alt="">
                            </div>
                        <?php else: ?>
                            <div class="quote-box d-flex">
                                <div class="quote-react remove-icon-message">
        ...
        <?php if(!empty($message->thumbsup)&&empty($message->message)): ?>
            <div class="d-flex user-quote user-reply justify-content-end">
                <div class="d-flex user-quote">
                    ...
                    <div class="chat-react mt-2"><img class="rounded" src="<?php echo e(url('assets/frontend/images/like-lg.png')); ?>" alt=""></div>
                </div>
            </div>
        <?php endif; ?>
    <?php endif; ?>
...
<?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
<?php endif; ?><?php /**PATH D:\AGUNG MUSTAQIM\drive-download-20250218T071143Z-001\PROJECT-BY-LARAGON\PROJECT-BY-LARAGON\Sociopro\resources\views/frontend/chat/single-message.blade.php ENDPATH**/ ?>