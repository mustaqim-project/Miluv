        ...
        <?php if(Route::currentRouteName() == 'timeline' ||Route::currentRouteName() == 'profile' || Route::currentRouteName() == 'single.group'): ?>
            <div class="post-options justify-content-center">
                <button class="btn" data-bs-toggle="modal" data-bs-target="#createPost" onclick="$('#createPost').modal('show');"><img
                        ...
                        alt="photo"></button>
                <button class="btn" data-bs-toggle="modal" data-bs-target="#createPost" onclick="$('#createPost').modal('show');"><img
                        src="<?php echo e(url('storage/images/location.png')); ?>" alt="photo"
                        alt="photo"></button>
                <button class="btn" data-bs-toggle="modal" data-bs-target="#createPost" onclick="$('#createPost').modal('show');"><img
                        src="<?php echo e(url('storage/images/camera.svg')); ?>"
                        alt="photo"></button>
                <button class="btn" data-bs-toggle="modal" data-bs-target="#createPost" onclick="$('#createPost').modal('show');"><img
                        src="<?php echo e(url('storage/images/plus-circle-fill.svg')); ?>"
                        alt="photo"></button>
            </div>
       <?php endif; ?>
...
<?php /**PATH D:\AGUNG MUSTAQIM\drive-download-20250218T071143Z-001\PROJECT-BY-LARAGON\PROJECT-BY-LARAGON\Sociopro\resources\views/frontend/main_content/create_post.blade.php ENDPATH**/ ?>