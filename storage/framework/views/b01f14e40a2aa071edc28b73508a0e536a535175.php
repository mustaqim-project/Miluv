        ...
        <div class="widget">
            <div class="d-flex align-items-center">
                ...
                <?php if($current_hour >= 5 && $current_hour < 12): ?>
                    <img class="img-fluid" src="<?php echo e(url('assets/frontend/images/sun.svg')); ?>" height="30px"
                        width="30px" alt="">
                <?php elseif($current_hour >= 12 && $current_hour < 17): ?>
                    <img class="img-fluid" src="<?php echo e(url('storage/images/cloud-sun.png')); ?>" alt="">
                    
                <?php else: ?>
                  <img class="img-fluid" src="<?php echo e(url('assets/frontend/images/moon2.png')); ?>" height="30px"
                width="30px" alt="">
                <?php endif; ?>
            ...
            <div class="sidebar">
                <div class="widget paid_sidebar">
                    ...
                    <div class="member-img">
                        <img src="<?php echo e(url('assets/frontend/paid-content/images/new/Notification-icon.png')); ?>"
                            alt="" />
                    </div>
...
<?php /**PATH D:\AGUNG MUSTAQIM\drive-download-20250218T071143Z-001\PROJECT-BY-LARAGON\PROJECT-BY-LARAGON\Sociopro\resources\views/frontend/right_sidebar.blade.php ENDPATH**/ ?>